...
public class NewGameWindow {
    ...
    private static TextField foodMultiplierInput;
    ...
    public static boolean display() {
        ...
        foodMultiplierInput = new TextField();
        foodMultiplierInput.setPromptText("1.0");
        GridPane.setConstraints(foodMultiplierInput, 1, 3);
        ...
        createButton.setOnAction(actionEvent -> {
            try {
                ...
                foodMultiplier = Float.parseFloat(foodMultiplierInput.getText());
                ...
                if(foodDropChance < 0 || foodDropChance > 1.0 || stateDelay < 0 || stateDelay > 10000 ||
                        baseFood < 0 || baseFood > 100 || foodMultiplier < 0 || foodMultiplier > 100 ||
                        pingDelay < 0 || pingDelay > 10000 || nodeTimeout < 0 || nodeTimeout > 10000 ||
        ...
        grid.getChildren().addAll(widthLabel, widthInput,
                ...
                foodMultiplyerLabel, foodMultiplierInput,
    ...
    public static float getFoodMultiplier() {
