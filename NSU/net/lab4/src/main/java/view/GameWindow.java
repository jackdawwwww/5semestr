...
public class GameWindow {
    ...
    public GameWindow(SnakesProto.GameConfig _gameConfig, Discoverer _discoverer, String name, SnakesProto.NodeRole _nodeRole, Node hi) {
    ...
    public void setNodeRole(proto.SnakesProto.NodeRole _nodeRole) {
